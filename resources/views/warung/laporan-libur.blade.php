...
@section('header-actions')
    <a href="{{ route('warung.laporan-libur.pdf', ['warung_id' => request('warung_id'), 'from' => request('from', now()->startOfMonth()->format('Y-m-d')), 'to' => request('to', now()->format('Y-m-d'))]) }}" class="btn btn-danger">
