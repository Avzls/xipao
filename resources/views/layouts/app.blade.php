        ...
        >
            ...
            <div class="px-4 py-4 border-b border-primary-700 flex items-center justify-between">
                <div class="flex items-center gap-2" x-show="!sidebarMinimized">
                    <img src="{{ asset('images/logo.png') }}" alt="Xipao" class="w-10 h-10 rounded-lg object-cover">
                    <div>
                        <h1 class="text-lg font-bold text-white">Xipao</h1>
                        <p class="text-xs text-white/60">Sistem Stok</p>
                    </div>
                </div>
                <img src="{{ asset('images/logo.png') }}" alt="Xipao" class="w-8 h-8 rounded-lg object-cover" x-show="sidebarMinimized">
            ...
            <!-- Settings -->
            <div class="px-2 mt-2 pt-2 border-t border-primary-700">
                <a href="{{ route('settings.index') }}" class="sidebar-link" :class="{ 'justify-center': sidebarMinimized, 'active': {{ request()->routeIs('settings.*') ? 'true' : 'false' }} }" title="Pengaturan">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
